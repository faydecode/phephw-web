...
$route['bid-placed-simpan'] = "C_public_produk/simpan";
$route['bid-placed-simpan/(:any)'] = 'C_public_produk/simpan';

$route['bid-placed-hapus-bid'] = "C_public_produk/hapus_bid";
$route['bid-placed-hapus-bid/(:any)'] = 'C_public_produk/hapus_bid';
$route['bid-placed-hapus-bid/(:any)/(:any)'] = 'C_public_produk/hapus_bid';
//PUBLIC
