<?php
	...
	class C_home extends CI_Controller
	{
		...
		public function index()
		{
			...
			$list_auction = $this->M_auction->list_auction_limit(' WHERE DATE(NOW()) >= DATE(A.date_mulai)  AND  DATE(NOW()) <= DATE(date_sampai)  ',0,1000);
		...
		public function by()
		{
			...
			if($type != 0)
			{
				$list_auction = $this->M_auction->list_auction_limit(' WHERE DATE(NOW()) >= DATE(A.date_mulai)  AND  DATE(NOW()) <= DATE(A.date_sampai) ',0,1000);
