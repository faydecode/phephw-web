...
class C_admin_satuan extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			*/
				...
				$config['first_url'] = site_url('toko-satuan?'.http_build_query($_GET));
				$config['base_url'] = site_url('toko-satuan/');
	...
	public function simpan()
	{
		if (!empty($_POST['stat_edit']))
		{
			...
			header('Location: '.base_url().'toko-satuan?'.http_build_query($_GET));
		}
		else
		{
